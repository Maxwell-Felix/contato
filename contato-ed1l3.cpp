...
int main(int argc, char** argv){	
	...
	for(int i = 0; i < 10; i++){	
		...
		cout << "M?s de nascimento do Contato " << i + 1 << ": ";
		cin >> m;
	...
	cout << "\nM?dia de idade: " << media << endl;
	
	Pausa();
	

	cout << "Contatos cuja idade ? maior que a m?dia\n" << endl;
	...
	cout << "\nTotal de contatos maiores de idade: " << maiorIdade << endl;
